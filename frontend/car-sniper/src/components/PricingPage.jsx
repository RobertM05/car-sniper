...
const PricingPage = () => {
    ...
    return (
        <div className="container" style={{ paddingTop: '6rem' }}>
            <Helmet><title>Pricing | Motorbit</title><meta name="description" content="Dealer subscription plans — Free, Premium (50EUR/mo), and Enterprise (200EUR/mo). List your cars on Motorbit." /><link rel="canonical" href="https://motorbit.ro/pricing" /></Helmet>
