...
const translations = {
    ro: {
        ...
        dealOfTheDay: {
            title: 'Oferta Zilei',
            badge: 'Cel mai bun deal în ultimele 24h',
            topDealsTitle: 'Top oferte acum',
            topDealsSubtitle: 'Cele mai bune prețuri față de media pieței, actualizate în timp real',
            viewAll: 'Vezi toate',
            marketTitle: 'MEDIA PIEȚEI',
            avgPrice: 'Preț mediu',
            avgYear: 'An mediu',
            avgKm: 'Km mediu',
            vsPiata: 'vs. piață',
            savedVsAvg: 'economisit față de media',
    ...
    en: {
        ...
        dealOfTheDay: {
            ...
            badge: 'Best deal in the last 24h',
            topDealsTitle: 'Top deals now',
            topDealsSubtitle: 'Best prices vs. market average, updated in real time',
            viewAll: 'View all',
            marketTitle: 'MARKET AVERAGE',
            avgPrice: 'Avg price',
            avgYear: 'Avg year',
            avgKm: 'Avg km',
            vsPiata: 'vs. market',
            savedVsAvg: 'saved vs. average',
